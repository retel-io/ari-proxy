		...
		new TestKit(system) {
			{
				...
				send(callContextProvider, new ProvideCallContext(RESOURCE_ID, ProviderPolicy.LOOKUP_ONLY));
		...
		{
			{
				...
				callContextProvider.tell(new RegisterCallContext(RESOURCE_ID, CALL_CONTEXT), getRef());
